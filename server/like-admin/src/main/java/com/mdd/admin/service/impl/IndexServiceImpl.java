...
public class IndexServiceImpl implements IIndexService {
    ...
    public Map<String, Object> console() {
        ...
        version.put("name", ConfigUtils.get("website", "name", "xmgadmin"));
        version.put("version", GlobalConfig.version);
        version.put("website", "www.xmgai.cn");
        version.put("based", "Vue3.x、ElementUI、MySQL");
        Map<String, String> channel = new LinkedHashMap<>();
        channel.put("gitee", "https://www.xmgai.cn");
        channel.put("website", "https://www.xmgai.cn");
    ...
    public Map<String, Object> config() {
        ...
        map.put("webLogo", website.getOrDefault("logo", ""));
        map.put("webFavicon", website.getOrDefault("favicon", ""));
        map.put("webBackdrop", website.getOrDefault("backdrop", ""));
