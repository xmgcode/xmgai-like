...
public class GenController {
     ...
     */
    @GetMapping("/detail")
    public AjaxResult<Map<String, Object>> detail(@Validated @IDMust() @RequestParam("id") String id) {
    ...
    public AjaxResult<Object> syncTable(@Validated @IDMust() @RequestParam("id") String id) {
    ...
    public AjaxResult<Map<String, String>> previewCode(@Validated @IDMust() @RequestParam("id") String id) {
