...
public class GenerateServiceImpl implements IGenerateService {
    ...
    public Map<String, Object> detail(String id) {
        ...
        base.put("createTime", genTable.getCreateTime());
        base.put("updateTime", genTable.getUpdateTime());
        maps.put("base", base);
    ...
    @Override
    @Transactional
    public void deleteTable(List<String> ids) {
        for (String id : ids) {
    ...
    private void genAutoMenu(GenTable table) {
        if (table.getMenuStatus().equals(1)) {
            ...
            for (String op : Arrays.asList("detail", "add", "edit", "del")) {
                ...
                systemAuthMenu.setCreateTime(new Date());
                systemAuthMenu.setUpdateTime(new Date());
