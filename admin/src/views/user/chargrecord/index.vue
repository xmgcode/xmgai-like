  ...
  <div class="index-lists">
    <el-card class="!border-none" shadow="never">
      ...
      >
        ...
        <el-form-item label="获取点数" prop="obtainPoints">
          <el-input class="w-[280px]" v-model="queryParams.obtainPoints" />
        </el-form-item>
    ...
    <el-card class="!border-none mt-4" shadow="never">
      ...
      >
        ...
        <el-table-column label="获取点数" prop="obtainPoints" min-width="100" />
...
<script lang="ts" setup name="chargrecord">
import { chargrecordDelete, chargrecordLists } from "@/api/user/chargrecord";
